          ...
          <div class="leading-loose">
            ...
            >
              ...
              >
                ...
                <div class="max-w-sm rounded overflow-hidden shadow-inner p-1 leading-snug mt-4">
                  <g-image
                    class="w-full"
                  ...
                  <div class="px-6 py-4">
                    <div class="font-bold text-gray-400 text-sm mb-2">Pro Velo</div>
                    <p class="text-gray-400 text-sm">
                      Pro Velo promotes bicycling in Brussels.
                    </p>
                    <a
                  href="https://www.provelo.org/en"
                  class="text-gray-400 italic text-sm flex flex-row items-center mt-3"
                  target="_blank"
                >
                  <svg
            ...
            >
              ...
              >
                ...
                <svg
                  ...
                  viewBox="0 0 24 24"
                  stroke="currentColor"
                  class="flex-none w-5 h-5 mr-2 pb-1 inline text-gray-500"
                >
                  <path
                    stroke-linecap="round"
                    stroke-linejoin="round"
